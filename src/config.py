...
ANCHO = 1050                     # Ancho de la ventana en píxeles
...
NEON_ROSA = (255, 0, 110)
NEON_CIAN = (0, 243, 255)
NEON_VERDE = (0, 255, 157)
NEON_PURPURA = (157, 0, 255)
NEON_NARANJA = (255, 149, 0)
NEON_AMARILLO = (255, 230, 0)

# Lista de colores para usar aleatoriamente
COLORES_CIRCULOS = [NEON_ROSA, NEON_CIAN, NEON_VERDE, NEON_PURPURA, NEON_NARANJA, NEON_AMARILLO]
COLORES_TITULO = [NEON_ROSA, NEON_NARANJA, NEON_AMARILLO, NEON_VERDE, NEON_CIAN, NEON_PURPURA]
